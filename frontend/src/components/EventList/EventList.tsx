...
const EventList = () => {
  ...
  return (
    <>
      ...
      <Grid component="article" container spacing={2.5} sx={{ mb: 5, alignItems: 'baseline' }}>
        <Grid
          item
          lg={4}
          md={6}
        ...
        >
          ...
          />
          <StyledIconButton aria-label="filter" title="Фильтр" sx={{ ml: 'auto', mb: -1 }}>
        ...
        <Grid
          ...
          xs={6}
          sx={{
            display: 'flex', gap: 2.5, alignItems: 'baseline',
          }}
        >
