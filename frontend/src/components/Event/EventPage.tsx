...
const EventPage = () => {
  const photo = 'https://cs4.pikabu.ru/post_img/big/2015/08/06/8/1438865092_1172094034.png';
  return (
    <>
      {photo && (
        <Box
      ...
      <Stack direction="row"
        ...
        <Typography variant={'caption'} fontSize={16} fontWeight={300} sx={{ fontStyle: 'italic' }}
                    maxWidth={280}>
